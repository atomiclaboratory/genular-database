...
```
The goal of `genular` is to provide a comprehensive toolkit for interacting with the [Genular API](https://genular.atomic-lab.org/api-docs/), facilitating the retrieval and analysis of genomic data directly within R.
